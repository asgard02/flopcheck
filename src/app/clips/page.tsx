...
export default function AnalysePage() {
  ...
  useEffect(() => {
    ...
    const pending = sessionStorage.getItem("vyrll_pending_url");
    if (pending) {
      sessionStorage.removeItem("vyrll_pending_url");
      setUrl(pending);
    }
  }, []);
          ...
          <div className="w-full max-w-5xl flex flex-col">
            <div className="flex flex-col items-center justify-center py-8">
              ...
              <h1 className="font-[family-name:var(--font-syne)] font-extrabold text-3xl sm:text-4xl text-center text-white mb-8 leading-tight">
                Turn your YouTube & Twitch videos into{" "}
                <span className="text-[#9b6dff]">viral clips</span>
              </h1>
